...
def config_parser(cmd=None):
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['blender', 'llff', 'llff_3dovs', 
                                 'nsvf', 'dtu','tankstemple', 'own_data', 'llff_json', 
                                 'replica', 'replica_3dovs', 'replica_CLIP', 
                                 'scannet', 'scannet_3dovs', 'scannet_CLIP', 
                                ])
    ...
    parser.add_argument('--ScanNet_Convert', default=False, action="store_true",
                        help='Converting the ScanNet IDs')
    ...
    parser.add_argument("--update_pseudo_step", type=int, default=1000,
                        help='the step for updating pseudo labels')     
    parser.add_argument("--loaded_center_x", type=float, default=0.,
                        help='the center_x of camera for novel view synthesis')     
    parser.add_argument("--loaded_center_y", type=float, default=0.,
                        help='the center_y of camera for novel view synthesis')
    parser.add_argument("--loaded_center_z", type=float, default=0.,
                        help='the center_z of camera for novel view synthesis')
    ...
    parser.add_argument("--relation_weight", type=float, default=0.)
    parser.add_argument("--ssim_relation_weight", type=float, default=0.)
    parser.add_argument("--p2p_relation_weight", type=float, default=0.)    
    parser.add_argument("--Textp2p_relation_weight", type=float, default=0.)    
    ...
    parser.add_argument("--convert_scannet_IDS", type=int, action="append")
