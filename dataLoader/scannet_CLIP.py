...
class scannetDataset_clip(Dataset):
    def __init__(self, datadir, patch_size=256, patch_stride=1, split='train', downsample=1.0, wh=[1296, 968], 
                 is_stack=False, skip_every_for_val_split=10, clip_input=1., loaded_center=[0., 0., 0.], convert_scannet_IDS=None):
        ...
        self.convert_scannet_IDS = convert_scannet_IDS
    ...
    def read_meta(self):
        ...
        seg_dir_sorted = sorted(glob.glob(os.path.join(self.root_dir, 'semantic/*')))   # semantic 
